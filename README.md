...
| [Flutter continuous integration](docs/flutter-ci.md) | Locked SDK/dependencies, analysis, 158 tests, Wasm release compilation, standard web release build, and trust boundary |

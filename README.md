...
| Depth-frame boundary | Implemented foundation | Capability-gated native request, normalized coordinates, bounded typed point-cloud validation |
...
At the latest verified point, the Flutter suite contains **144 passing tests**. Run it locally because the count evolves.
...
| [Flutter continuous integration](docs/flutter-ci.md) | Locked SDK/dependencies, analysis, 144 tests, Wasm release compilation, standard web release build, and trust boundary |
| [Phase 6B depth/point-cloud contract](docs/phase-6b-depth-point-cloud-contract.md) | Capability gating, normalized coordinates, point safety limits, fail-closed native boundary, and reconstruction roadmap |

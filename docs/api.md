...
Phase 1 routes: `POST /v1/auth/register`, `/login`, `/refresh`, `/logout`; `GET /v1/users/me`; CRUD `/v1/projects`; `POST /v1/projects/:id/sync`; `GET /v1/projects/:id/changes`; and `GET /health`.
